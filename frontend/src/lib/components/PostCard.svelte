...
<div class="card" onclick={onclick} role="button" tabindex="0" onkeydown={(e) => e.key === 'Enter' && onclick?.()}>
	...
	<div class="footer">
		<div class="footer-item upvote-btn" onclick={handleUpvote} role="button" tabindex="0" onkeydown={(e) => e.key === 'Enter' && handleUpvote(e)}>
