...
<div class="dev-dock">
    ...
    <div class="buttons">
        <button onclick={() => setRole('student')} class:active={$user?.role === 'student'}>STU</button>
        <button onclick={() => setRole('faculty')} class:active={$user?.role === 'faculty'}>FAC</button>
        <button onclick={() => setRole('authority')} class:active={$user?.role === 'authority'}>AUT</button>
        <button onclick={() => setRole('admin')} class:active={$user?.role === 'admin'}>ADM</button>
    </div>
</div>
